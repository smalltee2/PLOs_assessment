...
if GSHEETS_AVAILABLE:
    class GoogleSheetsManager:
        ...
        def setup_assessment_sheets(self, spreadsheet):
            ...
            try:
                # Define sheet structures - เพิ่ม Interpretation sheet
                sheets_config = {
                    'Assessment_Summary': [
                    ...
                    # เพิ่ม Sheet ใหม่สำหรับการแปลผล
                    'Interpretation': [
        ...
        def save_interpretation_data(self, spreadsheet, assessment_data):
            ...
            try:
                ...
                assessment_id = assessment_data.get('assessment_id', datetime.now().strftime('%Y%m%d_%H%M%S'))
