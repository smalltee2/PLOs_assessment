...
# [Keep all the existing constants and dictionaries - COURSE_DESCRIPTIONS, YLO_STRUCTURE, etc.]
...
# [Keep all the existing functions - check_ai_availability, extract_text_from_file, etc.]
    ...
    if low_clos:
        ...
        for clo_code, clo_data in low_clos:
            with st.expander(f"แนวทางปรับปรุง {clo_code} (คะแนน: {clo_data['score']:.1f}%)"):
                ...
                missing_keywords = [kw for kw in COURSE_DESCRIPTIONS[st.session_state.selected_course_code]['keywords'][clo_code] 
...
def main():
    ...
    <div class="main-header">
        ...
        <p style="font-size: 0.9em; opacity: 0.9;">
            📁 นำเข้าไฟล์ | 🤖 วิเคราะห์ด้วย AI | 📊 ประเมินหลายระดับ | 4 CLOs ต่อรายวิชา
        </p>
    </div>
    """, unsafe_allow_html=True)
    
    # Create tabs for better organization
    tab1, tab2, tab3, tab4 = st.tabs(["🎯 การประเมิน", "📚 ข้อมูลหลักสูตร", "📖 คู่มือการใช้งาน", "ℹ️ เกี่ยวกับระบบ"])
...
และการวิเคราะห์ข้อมูลด้วยเทคนิคทางสถิติ
    ...
    with tab4:
        ...
        st.markdown("""
        ### Enhanced Multi-Level Assessment System
        
        ระบบประเมินผลการเรียนรู้แบบหลายระดับที่พัฒนาขึ้นเพื่อช่วยอาจารย์และผู้สอน
        ในการประเมินความสอดคล้องของเนื้อหาการสอนกับผลการเรียนรู้ที่คาดหวัง
        
        **คุณสมบัติหลัก:**
        - 📊 วิเคราะห์ความสอดคล้อง CLO, PLO, YLO
        - 🤖 รองรับการวิเคราะห์ด้วย AI
        - 📁 นำเข้าไฟล์ PDF และ PowerPoint
        - 📈 แสดงผลด้วย Gauge Charts และ Sankey Diagram
        - 💡 ให้คำแนะนำเชิงลึกสำหรับการปรับปรุง
        
        **เวอร์ชัน:** 2.0 (Enhanced)
        **อัพเดตล่าสุด:** พฤศจิกายน 2024
        """)
        st.markdown('</div>', unsafe_allow_html=True)
